...
def JsonHandler():
    if request.is_json:
        ...
        if content['event_name'] == "project_create":
            ...
            #pipe.execute()
            logging.info('Project {0} Created.'.format(content['name']))
            return "OK"
